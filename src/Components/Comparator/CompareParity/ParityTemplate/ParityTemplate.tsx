    ...
    render() {
        ...
        return <div className='ParityTemplate Comparator__template'>
            ...
            <svg xmlns='http://www.w3.org/2000/svg' width='182' height='182' style={this.state.svgStyle}>
                <circle className='men' cy='91' cx='91' r={this.state.rayon}/>
                <circle style={this.state.pathStyle} className='women' cy='91' cx='91' r={this.state.rayon}/>
            </svg>
            <div className='ParityTemplate__items'>
                <div className='ParityTemplate__item'>
                    ...
                    <i className='ParityTemplate__icon fas fa-mars'/>
                </div>
                <div className='ParityTemplate__item'>
                    <i className='ParityTemplate__icon fas fa-venus'/>
