            ...
            <div className='BrandNewTl__items'>
                {this.state.data.map((woman: any, i: number) => <div className='BrandNewTl__item' key={i}>
                    ...
                    <ul className='BrandNewTl__laureats'>
                        {woman.map((li: { idpeople: number }, y: number) => <li className='BrandNewTl__laureat' key={y} onClick={e => this.displayWoman(e, li)}>
                                <div
                                    className='BrandNewTl__image'
                                    style={{background: `url('./women/${li.idpeople}.jpg') no-repeat center/cover`}}
                                />
                            </li>,
                        )}
                    </ul>
